    ...
    if (data?.length === 0) {
        return (
            <motion.div
                ...
                <p className='font-bold text-gray-800  text-base'>All cought up!</p>
            ...
            <div className='flex-items-center justify-between px-1 mb-1'>
                <p className='text-xs font-semibold uppercase tracking-widest text-gray-400'>
                    {type === "partner" ? "Pending Partner Reviews" :
                        type === "kyc" ? "Pending KYC Reviews" : "Pending Vehicle Reviews"
                    }
                </p>
                ...
                return (
                    ...
                    >
                        <div className='flex items-center gap-3 min-w-0'>
                            <div className='w-10 h-10 rounded-xl flex items-center justify-center text-sm  font-bold bg-purple-100 text-purple-800'>{name.charAt(0).toUpperCase() ?? <User size={14} />}</div>
